...
export function NavBody({ children, className, visible }: NavBodyProps) {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-[90rem] flex-row items-center justify-between self-start rounded-lg bg-transparent px-4 py-2 lg:flex dark:bg-transparent",
...
export function MobileNavToggle({
  ...
  return isOpen ? (
    <CloseOutlined className="text-black dark:text-white" onClick={onClick} />
  ) : (
    <MenuOutlined className="text-black dark:text-white" onClick={onClick} />
  );
}
